...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btRigidBody*>* tmp = bodyList.getFirst();
	p2List_item<btRigidBody*>* previous = bodyList.getFirst();
	while (tmp)
	{
		tmp = tmp->next;
	...
	p2List_item<btCollisionShape*>* tmp2 = shapeList.getFirst();
	p2List_item<btCollisionShape*>* previous2 = shapeList.getFirst();
	while (tmp2)
	{
		tmp2 = tmp2->next;
		delete previous2;
